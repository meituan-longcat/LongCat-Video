...
const HSRecurVideoGallerySection4: React.FC<VideoGallerySectionProps> = ({
  sectionId,
  sectionStyle,
  containerStyle,
  liquidGlassCard,
      ...
      <div style={containerStyle}>
        <div style={{ textAlign: 'center', marginBottom: '60px' }}>
          ...
          <p style={{ 
            ...
            By inputting distinct prompts for each video continuation, LongCat-Video enables interactive video generation capabilities.
          </p>
        </div>
...
export default HSRecurVideoGallerySection4;