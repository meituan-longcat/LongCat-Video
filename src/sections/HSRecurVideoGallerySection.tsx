...
const HSRecurVideoGallerySection: React.FC<VideoGallerySectionProps> = ({
  sectionId,
  sectionStyle,
  containerStyle,
  liquidGlassCard,
          ...
          >
            {galleryGroups.map((group, index) => (
              ...
              >
                ...
                <div style={{
                  display: 'grid',
                  gridTemplateColumns: group.title === 'style' ? 'repeat(1, 1fr)' : 'repeat(auto-fit, minmax(400px, 1fr))',
                  gap: '10px'
                }}>
...
export default HSRecurVideoGallerySection;