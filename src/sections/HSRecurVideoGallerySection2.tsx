          ...
          >
            {galleryGroups.map((group, index) => (
              ...
              >
                ...
                <div style={{
                  display: 'grid',
                  gridTemplateColumns: group.title === '0' ? 'repeat(auto-fit, minmax(400px, 1fr))' : group.title === '1' ? 'repeat(2, 1fr)' : 'repeat(1, 1fr)',
                  ...
                  {group.videometas.map((videometa) => (
                    <VideoCard
                      ...
                      height= {group.title === '0' ? '300px' : group.title === '1' ? '350px' : '240px'}
                    />
                  ))}
                </div>
              </div>
